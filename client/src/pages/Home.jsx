...
async function sendEmailNotification(productName, daysUntilExpiry,email,pId) {
  try {
      const response = await fetch(`http://localhost:9000/send-email/alert/${pId}`, {
          method: "POST",
          headers: {
...
async function isExpiredEmailNotification(productName, daysUntilExpiry,email,pId) {
  try {
      const response = await fetch(`http://localhost:9000/send-email/isExpired/${pId}`, {
          method: "POST",
          headers: {
              "Content-Type": "application/json",
          },
